...
static void glad_gl_load_GL_IMG_user_clip_plane(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
...
static void glad_gl_load_GL_OES_blend_equation_separate(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
...
static void glad_gl_load_GL_OES_blend_func_separate(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
...
static void glad_gl_load_GL_OES_blend_subtract(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
    if(!context->OES_blend_subtract) return;
    context->BlendEquationOES = (PFNGLBLENDEQUATIONOESPROC) load(userptr, "glBlendEquationOES");
}
static void glad_gl_load_GL_OES_draw_texture(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
...
static void glad_gl_load_GL_OES_framebuffer_object(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
...
static void glad_gl_load_GL_OES_matrix_palette(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
...
static void glad_gl_load_GL_OES_point_size_array(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
...
static void glad_gl_load_GL_OES_texture_cube_map(GladGLContext *context, GLADuserptrloadfunc load, void* userptr) {
...
static void glad_gl_resolve_aliases(GladGLContext *context) {
    ...
    if (context->ColorSubTable == NULL && context->ColorSubTableEXT != NULL) context->ColorSubTable = (PFNGLCOLORSUBTABLEPROC)context->ColorSubTableEXT;
    if (context->ColorSubTableEXT == NULL && context->ColorSubTable != NULL) context->ColorSubTableEXT = (PFNGLCOLORSUBTABLEEXTPROC)context->ColorSubTable;
    if (context->ColorTable == NULL && context->ColorTableEXT != NULL) context->ColorTable = (PFNGLCOLORTABLEPROC)context->ColorTableEXT;
    if (context->ColorTable == NULL && context->ColorTableSGI != NULL) context->ColorTable = (PFNGLCOLORTABLEPROC)context->ColorTableSGI;
    if (context->ColorTableEXT == NULL && context->ColorTable != NULL) context->ColorTableEXT = (PFNGLCOLORTABLEEXTPROC)context->ColorTable;
    if (context->ColorTableEXT == NULL && context->ColorTableSGI != NULL) context->ColorTableEXT = (PFNGLCOLORTABLEEXTPROC)context->ColorTableSGI;
    if (context->ColorTableParameterfv == NULL && context->ColorTableParameterfvSGI != NULL) context->ColorTableParameterfv = (PFNGLCOLORTABLEPARAMETERFVPROC)context->ColorTableParameterfvSGI;
    if (context->ColorTableParameterfvSGI == NULL && context->ColorTableParameterfv != NULL) context->ColorTableParameterfvSGI = (PFNGLCOLORTABLEPARAMETERFVSGIPROC)context->ColorTableParameterfv;
    if (context->ColorTableParameteriv == NULL && context->ColorTableParameterivSGI != NULL) context->ColorTableParameteriv = (PFNGLCOLORTABLEPARAMETERIVPROC)context->ColorTableParameterivSGI;
    if (context->ColorTableParameterivSGI == NULL && context->ColorTableParameteriv != NULL) context->ColorTableParameterivSGI = (PFNGLCOLORTABLEPARAMETERIVSGIPROC)context->ColorTableParameteriv;
    if (context->ColorTableSGI == NULL && context->ColorTable != NULL) context->ColorTableSGI = (PFNGLCOLORTABLESGIPROC)context->ColorTable;
    if (context->ColorTableSGI == NULL && context->ColorTableEXT != NULL) context->ColorTableSGI = (PFNGLCOLORTABLESGIPROC)context->ColorTableEXT;
    ...
    if (context->ConvolutionFilter1D == NULL && context->ConvolutionFilter1DEXT != NULL) context->ConvolutionFilter1D = (PFNGLCONVOLUTIONFILTER1DPROC)context->ConvolutionFilter1DEXT;
    if (context->ConvolutionFilter1DEXT == NULL && context->ConvolutionFilter1D != NULL) context->ConvolutionFilter1DEXT = (PFNGLCONVOLUTIONFILTER1DEXTPROC)context->ConvolutionFilter1D;
    if (context->ConvolutionFilter2D == NULL && context->ConvolutionFilter2DEXT != NULL) context->ConvolutionFilter2D = (PFNGLCONVOLUTIONFILTER2DPROC)context->ConvolutionFilter2DEXT;
    if (context->ConvolutionFilter2DEXT == NULL && context->ConvolutionFilter2D != NULL) context->ConvolutionFilter2DEXT = (PFNGLCONVOLUTIONFILTER2DEXTPROC)context->ConvolutionFilter2D;
    if (context->ConvolutionParameterf == NULL && context->ConvolutionParameterfEXT != NULL) context->ConvolutionParameterf = (PFNGLCONVOLUTIONPARAMETERFPROC)context->ConvolutionParameterfEXT;
    if (context->ConvolutionParameterfEXT == NULL && context->ConvolutionParameterf != NULL) context->ConvolutionParameterfEXT = (PFNGLCONVOLUTIONPARAMETERFEXTPROC)context->ConvolutionParameterf;
    if (context->ConvolutionParameterfv == NULL && context->ConvolutionParameterfvEXT != NULL) context->ConvolutionParameterfv = (PFNGLCONVOLUTIONPARAMETERFVPROC)context->ConvolutionParameterfvEXT;
    if (context->ConvolutionParameterfvEXT == NULL && context->ConvolutionParameterfv != NULL) context->ConvolutionParameterfvEXT = (PFNGLCONVOLUTIONPARAMETERFVEXTPROC)context->ConvolutionParameterfv;
    if (context->ConvolutionParameteri == NULL && context->ConvolutionParameteriEXT != NULL) context->ConvolutionParameteri = (PFNGLCONVOLUTIONPARAMETERIPROC)context->ConvolutionParameteriEXT;
    if (context->ConvolutionParameteriEXT == NULL && context->ConvolutionParameteri != NULL) context->ConvolutionParameteriEXT = (PFNGLCONVOLUTIONPARAMETERIEXTPROC)context->ConvolutionParameteri;
    if (context->ConvolutionParameteriv == NULL && context->ConvolutionParameterivEXT != NULL) context->ConvolutionParameteriv = (PFNGLCONVOLUTIONPARAMETERIVPROC)context->ConvolutionParameterivEXT;
    if (context->ConvolutionParameterivEXT == NULL && context->ConvolutionParameteriv != NULL) context->ConvolutionParameterivEXT = (PFNGLCONVOLUTIONPARAMETERIVEXTPROC)context->ConvolutionParameteriv;
    ...
    if (context->CopyColorSubTable == NULL && context->CopyColorSubTableEXT != NULL) context->CopyColorSubTable = (PFNGLCOPYCOLORSUBTABLEPROC)context->CopyColorSubTableEXT;
    if (context->CopyColorSubTableEXT == NULL && context->CopyColorSubTable != NULL) context->CopyColorSubTableEXT = (PFNGLCOPYCOLORSUBTABLEEXTPROC)context->CopyColorSubTable;
    if (context->CopyColorTable == NULL && context->CopyColorTableSGI != NULL) context->CopyColorTable = (PFNGLCOPYCOLORTABLEPROC)context->CopyColorTableSGI;
    if (context->CopyColorTableSGI == NULL && context->CopyColorTable != NULL) context->CopyColorTableSGI = (PFNGLCOPYCOLORTABLESGIPROC)context->CopyColorTable;
    if (context->CopyConvolutionFilter1D == NULL && context->CopyConvolutionFilter1DEXT != NULL) context->CopyConvolutionFilter1D = (PFNGLCOPYCONVOLUTIONFILTER1DPROC)context->CopyConvolutionFilter1DEXT;
    if (context->CopyConvolutionFilter1DEXT == NULL && context->CopyConvolutionFilter1D != NULL) context->CopyConvolutionFilter1DEXT = (PFNGLCOPYCONVOLUTIONFILTER1DEXTPROC)context->CopyConvolutionFilter1D;
    if (context->CopyConvolutionFilter2D == NULL && context->CopyConvolutionFilter2DEXT != NULL) context->CopyConvolutionFilter2D = (PFNGLCOPYCONVOLUTIONFILTER2DPROC)context->CopyConvolutionFilter2DEXT;
    if (context->CopyConvolutionFilter2DEXT == NULL && context->CopyConvolutionFilter2D != NULL) context->CopyConvolutionFilter2DEXT = (PFNGLCOPYCONVOLUTIONFILTER2DEXTPROC)context->CopyConvolutionFilter2D;
    ...
    if (context->GetColorTable == NULL && context->GetColorTableEXT != NULL) context->GetColorTable = (PFNGLGETCOLORTABLEPROC)context->GetColorTableEXT;
    if (context->GetColorTableEXT == NULL && context->GetColorTable != NULL) context->GetColorTableEXT = (PFNGLGETCOLORTABLEEXTPROC)context->GetColorTable;
    if (context->GetColorTableParameterfv == NULL && context->GetColorTableParameterfvEXT != NULL) context->GetColorTableParameterfv = (PFNGLGETCOLORTABLEPARAMETERFVPROC)context->GetColorTableParameterfvEXT;
    if (context->GetColorTableParameterfvEXT == NULL && context->GetColorTableParameterfv != NULL) context->GetColorTableParameterfvEXT = (PFNGLGETCOLORTABLEPARAMETERFVEXTPROC)context->GetColorTableParameterfv;
    if (context->GetColorTableParameteriv == NULL && context->GetColorTableParameterivEXT != NULL) context->GetColorTableParameteriv = (PFNGLGETCOLORTABLEPARAMETERIVPROC)context->GetColorTableParameterivEXT;
    if (context->GetColorTableParameterivEXT == NULL && context->GetColorTableParameteriv != NULL) context->GetColorTableParameterivEXT = (PFNGLGETCOLORTABLEPARAMETERIVEXTPROC)context->GetColorTableParameteriv;
    ...
    if (context->Histogram == NULL && context->HistogramEXT != NULL) context->Histogram = (PFNGLHISTOGRAMPROC)context->HistogramEXT;
    if (context->HistogramEXT == NULL && context->Histogram != NULL) context->HistogramEXT = (PFNGLHISTOGRAMEXTPROC)context->Histogram;
    ...
    if (context->Minmax == NULL && context->MinmaxEXT != NULL) context->Minmax = (PFNGLMINMAXPROC)context->MinmaxEXT;
    if (context->MinmaxEXT == NULL && context->Minmax != NULL) context->MinmaxEXT = (PFNGLMINMAXEXTPROC)context->Minmax;
    ...
    if (context->ResetHistogram == NULL && context->ResetHistogramEXT != NULL) context->ResetHistogram = (PFNGLRESETHISTOGRAMPROC)context->ResetHistogramEXT;
    if (context->ResetHistogramEXT == NULL && context->ResetHistogram != NULL) context->ResetHistogramEXT = (PFNGLRESETHISTOGRAMEXTPROC)context->ResetHistogram;
    if (context->ResetMinmax == NULL && context->ResetMinmaxEXT != NULL) context->ResetMinmax = (PFNGLRESETMINMAXPROC)context->ResetMinmaxEXT;
    if (context->ResetMinmaxEXT == NULL && context->ResetMinmax != NULL) context->ResetMinmaxEXT = (PFNGLRESETMINMAXEXTPROC)context->ResetMinmax;
    ...
    if (context->SeparableFilter2D == NULL && context->SeparableFilter2DEXT != NULL) context->SeparableFilter2D = (PFNGLSEPARABLEFILTER2DPROC)context->SeparableFilter2DEXT;
    if (context->SeparableFilter2DEXT == NULL && context->SeparableFilter2D != NULL) context->SeparableFilter2DEXT = (PFNGLSEPARABLEFILTER2DEXTPROC)context->SeparableFilter2D;
...
int gladLoadGLSC2UserPtr(GLADuserptrloadfunc load, void *userptr) {
    return gladLoadGLSC2ContextUserPtr(gladGetGLContext(), load, userptr);
}
...
int gladLoadGLSC2(GLADloadfunc load) {
    return gladLoadGLSC2Context(gladGetGLContext(), load);
}
...
static int glad_gl_find_extensions_gles1(GladGLContext *context, int version) {
    ...
    context->QCOM_tiled_rendering = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_QCOM_tiled_rendering");
    context->QCOM_writeonly_rendering = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_QCOM_writeonly_rendering");
    context->APPLE_texture_2D_limited_npot = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_APPLE_texture_2D_limited_npot");
    context->IMG_texture_env_enhanced_fixed_function = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_IMG_texture_env_enhanced_fixed_function");
    context->IMG_user_clip_plane = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_IMG_user_clip_plane");
    context->OES_blend_equation_separate = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_blend_equation_separate");
    context->OES_blend_func_separate = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_blend_func_separate");
    context->OES_blend_subtract = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_blend_subtract");
    context->OES_draw_texture = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_draw_texture");
    context->OES_extended_matrix_palette = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_extended_matrix_palette");
    context->OES_framebuffer_object = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_framebuffer_object");
    context->OES_matrix_get = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_matrix_get");
    context->OES_matrix_palette = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_matrix_palette");
    context->OES_point_size_array = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_point_size_array");
    context->OES_point_sprite = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_point_sprite");
    context->OES_stencil8 = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_stencil8");
    context->OES_stencil_wrap = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_stencil_wrap");
    context->OES_texture_cube_map = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_texture_cube_map");
    context->OES_texture_env_crossbar = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_texture_env_crossbar");
    context->OES_texture_mirrored_repeat = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_OES_texture_mirrored_repeat");
...
int gladLoadGLES1UserPtr(GLADuserptrloadfunc load, void *userptr) {
    return gladLoadGLES1ContextUserPtr(gladGetGLContext(), load, userptr);
}
...
int gladLoadGLES1(GLADloadfunc load) {
    return gladLoadGLES1Context(gladGetGLContext(), load);
}
...
int gladLoaderLoadGLES1Context(GladGLContext *context) {
    int version = 0;
    void *handle = NULL;
    int did_load = 0;
    struct _glad_gles1_userptr userptr;
...
int gladLoaderLoadGLES1(void) {
    return gladLoaderLoadGLES1Context(gladGetGLContext());
}
